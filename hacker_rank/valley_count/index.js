...
// close attention to small details like topography. During his 
// last hike he took exactly  steps. For every step he took, he 
// noted if it was an uphill, , or a downhill,  step. Gary's hikes 
...
// Then he climbs out an up onto a mountain  units high. Finally, he 
...
function countingValleys(steps, path) {
  ...
  for (let step = 0; step < steps; step++) {
    if (path[step] === 'U') {
      // if altitude is ever -1 (below sea level) then we know we hit a valley
      if (altitude === -1) {
        valleysTraversed++;
      }
      altitude++;
