// Standard logarithmic merge sort function
// Time cost: O(nlog2^n)

// In merge sort, the idea is to divide the array in half, 
// sort the two halves, and then merge the two sorted halves 
// into one sorted whole. But how do we sort the two halves? 
// Well, we divide them in half, sort them, and merge the 
// sorted halves...and so on.
